...
import FrequencyDots from './frequency-dots';
...
function TranslateAlternativesItem(props: Props) {
  ...
  return [
    props.currentService ? (
      <td
        key={'plus'}
        className="inkahsubs-translate-alternative-item-add-to-learn"
    ...
    <td
      key={'translate'}
      className="inkahsubs-translate-alternative-item-translate"
      ref={translateNode}
    >
      {props.alternative[0]}
    </td>,
    <td
      key={'original'}
      className="inkahsubs-translate-alternative-item-original"
    >
      {props.alternative[1]?.slice(0, 3)?.join(', ')}
    </td>,
    <td
      key={'frequency'}
      className="inkahsubs-translate-alternative-item-frequency"
    >
